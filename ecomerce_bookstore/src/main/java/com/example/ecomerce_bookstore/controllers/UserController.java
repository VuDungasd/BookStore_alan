...
public class UserController {
    ...
    public ResponseEntity<UserResponse> getUsers(
            // Annotation RequestParam sử dụng để định nghĩa các tham số request các tham số này đểu là Optional (k bắt buộc)
            // (cung cấp giá trị mặc định nếu không được cung cấp)
